    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('p', {}, 'Arrastra la imagen aqui');
                p2 = this.createEls('p', {}, 'O haz click para seleccionar');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: './Img Upload/css/loading-spin.svg'});
